...
def vidya(close, length=None, drift=None, offset=None, **kwargs):
    ...
    def _cmo(source: Series, n:int , d: int):
        ...
        For some reason: from custom_pandas_ta.momentum import cmo causes
        custom_pandas_ta.momentum.coppock to not be able to import it's
        wma like from custom_pandas_ta.overlap import wma?
